...
import { Brain, Shield, BotIcon as Robot, Network, Lock, Sparkles, NotebookText, NotepadText, NotebookPenIcon, MoonIcon, MoonStar, LetterText, ArrowRightCircle, LoaderCircle, PenLine } from "lucide-react"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-20 mx-auto mt-12 mb-8">
                            {technologies.map((tech, index) => (
                                <motion.div
                                    ...
                                    className="h-full"
                                >
                                    <Card className="group hover:shadow-lg w-[27rem] transition-all duration-300 bg-card/50 backdrop-blur-sm border-border hover:bg-card/80 dark:hover:bg-gradient-to-br dark:hover:from-gray-800 dark:hover:to-gray-700 h-full flex flex-col">
